    ...
    return (
        <header className="fixed top-0 w-full z-50 border-b border-white/10 bg-white/70 backdrop-blur-xl transition-all duration-300 shadow-sm">
            <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <nav aria-label="Navigation principale" className="flex items-center gap-6 text-sm font-medium text-gray-600">
                    <Link href="/configurer-apn" className="hover:text-red-600 transition-colors">
                        Config APN
                    </Link>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <nav aria-label="Guides">
                        ...
                        <ul className="space-y-2 text-sm text-gray-500">
                            <li><Link href="/configurer-apn" className="hover:text-red-600 transition-colors">Configurer APN Free</Link></li>
                            <li><Link href="/blog" className="hover:text-red-600 transition-colors">Blog & Astuces</Link></li>
                            <li><Link href="/blog/pourquoi-5g-free-ne-marche-pas" className="hover:text-red-600 transition-colors">Problème 5G Free</Link></li>
                            <li><Link href="/blog/deux-apn-free-mmsfree-lequel-choisir" className="hover:text-red-600 transition-colors">Deux APN Free</Link></li>
                        </ul>
                    </nav>

                    <nav aria-label="Marques populaires">
                        <h4 className="font-semibold text-gray-900 mb-4">Marques Populaires</h4>
                        <ul className="space-y-2 text-sm text-gray-500">
                            <li><Link href="/marques/samsung" className="hover:text-red-600 transition-colors">Samsung</Link></li>
                            <li><Link href="/marques/apple" className="hover:text-red-600 transition-colors">Apple / iPhone</Link></li>
                            <li><Link href="/marques/xiaomi" className="hover:text-red-600 transition-colors">Xiaomi</Link></li>
